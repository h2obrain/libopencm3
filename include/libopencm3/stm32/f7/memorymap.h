...
/* PERIPH_BASE_APB2 + 0x1800 (0x4001 1800 - 0x4001 1BFF): Reserved */
#define SDMMC2_BASE			(PERIPH_BASE_APB2 + 0x1C00)
...
#define SDMMC1_BASE			(PERIPH_BASE_APB2 + 0x2C00)
#define SDIO_BASE			(PERIPH_BASE_APB2 + 0x2C00) /* compat. with f4 */
...
/* PERIPH_BASE_AHB2 + 0x50400 (0x5005 0400 - 0x5005 0FFF): Reserved */
#define JPEG_BASE			(PERIPH_BASE_AHB2 + 0x51000)
/* PERIPH_BASE_AHB2 + 0x50400 (0x5005 2000 - 0x5005 FFFF): Reserved */
