...
#define MAX_USER_CONTROL_CALLBACK	16//4
#define MAX_USER_SET_CONFIG_CALLBACK	16//4
...
struct _usbd_device {
	...
	usbd_endpoint_callback user_callback_ctr[32][3];//[8][3];
